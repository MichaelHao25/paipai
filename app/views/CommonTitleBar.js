  ...
  renderAndroid() {
    return (
      <View style={styles.container}>
        <StatusBar
          backgroundColor={this.props.color ? this.props.color : '#393A3E'}
          barStyle="light-content"
        />
        <View style={styles.content}>
        <View style={{
            backgroundColor: this.props.color ? this.props.color : Global.titleBackgroundColor,
            width: width,
            height: 50,
            flexDirection: 'row',
            alignItems: 'center'
...
const styles = StyleSheet.create({
  ...
  title: {
    color: '#FFFFFF',
    fontSize: Platform.OS=='ios'?FZ(22):16,
    flex: 1,
  },
  img: {
    width: 30,
