  ...
  render() {
    return (
      <View style={styles.container}>
        <CommonTitleBar nav={this.props.navigation} title={"推荐好友"} />
        <View style={[styles.content, { padding: 0 }]}>
          <Image source={{ uri: 'http://010404040404.oss-cn-beijing.aliyuncs.com/ppsj/pp01.png' }} style={{ flex: 1, resizeMode: 'center' }}></Image>
