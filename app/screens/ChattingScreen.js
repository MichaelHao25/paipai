...
import {Dimensions, FlatList, Image, PixelRatio, StyleSheet, Text, View, ToastAndroid,Platform,KeyboardAvoidingView} from 'react-native';
...
const listItemStyle = StyleSheet.create({
  ...
  time: {
    ...
    color: '#FFFFFF',
    marginTop: 10,
    fontSize: Platform.OS == 'ios' ? FZ(16) : 11,
  }
});
